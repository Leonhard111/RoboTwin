...
from dyn_model.model.language_encoder import LanguageEncoder
from dyn_model.model.resnet_encoder import ResNetEncoder
import hydra
import torch
import wandb
import logging
...
class Trainer:
    def __init__(self, cfg):
        ...
        if 'RobomimicImageDynamicsModelDataset' in dataset_class_path:
            ...
            dataset_params['shape_obs'] = self.cfg.env.shape_obs
        elif 'RobomimicImageDynamicsModelDataset' in dataset_class_path:
            dataset_params['shape_obs'] = self.cfg.env.shape_obs
