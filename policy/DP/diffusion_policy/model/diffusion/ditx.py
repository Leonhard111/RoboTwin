...
from diffusion_policy.model.diffusion.ditx_block import DiTXBlock, AdaptiveLayerNorm
...
class DiTX(nn.Module):
    ...
    def __init__(
        ...
        self.vis_cond_pos_embed = nn.Parameter(
            ...
            )  # learnable visual condition positional embedding  初始化为0不会影响图的梯度计算，又不是系数为0
